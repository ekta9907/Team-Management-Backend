...
module.exports = async (DB_NAME) => {
  ...
  if (dbConnection.models.UserNotificationMessage) {
    return dbConnection.models.UserNotificationMessage;
  }
  return dbConnection.model("UserNotificationMessage", UserNotificationMessageSchema);
};
