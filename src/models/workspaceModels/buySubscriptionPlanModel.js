...
module.exports = async (DB_NAME) => {
  ...
  if (dbConnection.models.BuySubscriptionPlan) {
    return dbConnection.models.BuySubscriptionPlan;
  }
  return dbConnection.model("BuySubscriptionPlan", BuySubscriptionPlanSchema);
};
